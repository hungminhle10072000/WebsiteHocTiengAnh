...
const USER_API_LOGIN = "https://server-english.herokuapp.com/authenticate";
const USER_API_ForgetPassWord = 'https://server-english.herokuapp.com/api/users/check-username-email';
...
class UserService {
    ...
    register(userDto, file) {
        ...
        return axios.post('https://server-english.herokuapp.com/register', formData,{
